...
package com.barrybecker4.puzzle.common1.model;
...
public class PuzzleNode<P, M> implements Comparable<PuzzleNode<P, M>> {
     ...
     */
    private PuzzleNode(P pos, M move, PuzzleNode<P, M> prev, int estimatedFutureCost) {
        this.position = pos;
        this.move = move;
        this.previous = prev;
     ...
     */
    private int getEstimatedFutureCost() {
