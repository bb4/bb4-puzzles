...
object PathVerificationCase {
  ...
  val cases: Seq[PathVerificationCase] = Seq(
    ...
    PathVerificationCase("NON_LOOP_PATH4", PathTstUtil.NON_LOOP_PATH4,
      ...
      1.2268292682926827),
    PathVerificationCase("LINEAR_PATH4", PathTstUtil.LINEAR_PATH4,
    ...
    PathVerificationCase("LOOP_PATH5", PathTstUtil.LOOP_PATH5,
      ...
      0),
    PathVerificationCase("IMPERFECT_LOOP_PATH5", PathTstUtil.IMPERFECT_LOOP_PATH5,
