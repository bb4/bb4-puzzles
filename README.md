...
When a release is published, download the installer for your OS from the [latest GitHub Release](https://github.com/bb4/bb4-puzzles/releases/latest) (macOS `.dmg`, Windows `.msi`, Linux `.deb`). The zip distribution is still available on the same release if you prefer to run from the command line.
