...
object Data {
  ...
  /** some difficult puzzles from https://dlbeer.co.nz/articles/sudoku.html */
  val DLBEER_551_9 = Array(
    Array(3, 7, 0, 0, 0, 9, 0, 0, 6),
    Array(8, 0, 0, 1, 0, 3, 0, 7, 0),
    Array(0, 0, 0, 0, 0, 0, 0, 0, 8),
    Array(0, 2, 0, 0, 8, 0, 0, 0, 5),
    Array(1, 8, 7, 0, 0, 0, 6, 4, 2),
    Array(5, 0, 0, 0, 2, 0, 0, 1, 0),
    Array(7, 0, 0, 0, 0, 0, 0, 0, 0),
    Array(0, 5, 0, 6, 0, 2, 0, 0, 7),
    Array(2, 0, 0, 3, 0, 0, 0, 6, 1)
  )
  val DLBEER_253_9 = Array(
    Array(0, 7, 0, 3, 0, 0, 0, 4, 0),
    Array(3, 0, 0, 0, 8, 0, 2, 0, 0),
    Array(2, 0, 1, 4, 0, 7, 0, 0, 0),
    Array(5, 0, 4, 0, 0, 0, 0, 9, 0),
    Array(0, 2, 0, 0, 0, 0, 0, 5, 0),
    Array(0, 1, 0, 0, 0, 0, 7, 0, 3),
    Array(0, 0, 0, 9, 0, 6, 3, 0, 2),
    Array(0, 0, 2, 0, 3, 0, 0, 0, 9),
    Array(0, 6, 0, 0, 0, 2, 0, 8, 0)
  )
  /*
  Array(
    Array(0, 0, 0, 0, 0, 0, 0, 0, 0),
