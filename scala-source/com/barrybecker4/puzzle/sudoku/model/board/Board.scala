...
class Board(val baseSize: Int) {
  ...
  protected var rowCells: Seq[CellArray] = _
  protected var colCells: Seq[CellArray] = _
  ...
  def getRowCells: Seq[CellArray] = rowCells
  def getColCells: Seq[CellArray] = colCells
