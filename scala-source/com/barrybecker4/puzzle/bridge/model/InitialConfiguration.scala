...
object InitialConfiguration {
  ...
  val CONFIGURATIONS = Seq(
    ...
    InitialConfiguration("Harder Problem", Array(7, 11, 2, 3, 5, 4, 1, 3, 12, 3, 15, 19, 8), 74), // or 74?
    InitialConfiguration("Big Problem", Array(7, 11, 2, 3, 17, 5, 4, 3, 12, 7, 14, 16, 1, 3, 12, 3, 15, 19, 8), 128), // 126
